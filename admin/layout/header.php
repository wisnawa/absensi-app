...
$id = $_SESSION['id'];
$result = mysqli_query($connection, "SELECT * FROM `pegawai` WHERE id = $id");
?>
<!doctype html>
<!--
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                            <?php while ($pegawai = mysqli_fetch_array($result)) : ?>
                                <span class="avatar avatar-sm" style="background-image: url(<?= base_url('assets/img/foto_pegawai/' . $pegawai['foto']); ?>)"></span>
                            <?php endwhile; ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <a href="<?= base_url('auth/logout.php'); ?>" class="dropdown-item logout-confirm">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link logout-confirm" href="<?= base_url('auth/logout.php'); ?>">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
